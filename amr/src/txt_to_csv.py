...
combine_df.to_csv(
    '/Users/wei/Job Application 2023/CARA Network/AMR /AMR Instagram data/Instagram 1 + 2 (only Caption).csv',index=False)
print('Instagram 1 + 2 (only Caption): ',combine_df.shape)
duplicated_combinedf_captions = combine_df[combine_df.duplicated('Caption')]
duplicated_combinedf_captions.to_excel('/Users/wei/Job Application 2023/CARA Network/AMR /AMR Instagram data/IG 1+2 duplicated caption'
                                       '.xlsx', index=False)
...
final_instagram.to_excel('/Users/wei/Job Application 2023/CARA Network/AMR /AMR Instagram data/Instagram 1 + 2 with all information.xlsx', index=False)
...
unique_final_instagram_url.to_excel('/Users/wei/Job Application 2023/CARA Network/AMR /AMR Instagram data/Instagram 1 + 2 with all information (unique URL only).xlsx', index=False)
...
duplicated_url.to_excel('/Users/wei/Job Application 2023/CARA Network/AMR /AMR Instagram data/duplicated_url in Instagram 1 + 2 with all information.xlsx', index=False)
...
duplicated_caption.to_excel('/Users/wei/Job Application 2023/CARA Network/AMR /AMR Instagram data/duplicated_caption in Instagram 1 + 2 with all information.xlsx', index=False)
