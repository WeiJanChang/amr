...
try:
    df = pd.read_json('/Users/wei/Google 雲端硬碟/Job Application 2023/CARA Network/AMR /AMR Instagram data/Antimicrobial resistance/Antimicrobial resistance 01 Jan 2017 - 01 July 2023.json')
...
try:
    df.to_csv('/Users/wei/Google 雲端硬碟/Job Application 2023/CARA Network/AMR /AMR Instagram data/Antimicrobial resistance/Antimicrobial resistance 01 Jan 2017 - 01 July 2023.csv', index=False)
except (FileNotFoundError, IOError) as e:
